...
int main(int argc, char *argv[]){
	...
	for(int i = 0; i < numOfTrainSamples; i++){
		...
		cout << "i = " << i << endl;		
		int neighborSize = train.getNeighborSize(rowTrain, colTrain, dem, flag, totalRows, totalCols,
	...
	for(int i = 0; i < numOfTestSamples; i++){
		...
		cout << "i = " << i << endl;		
		int neighborSize = test.getNeighborSize(rowTest, colTest, dem, flag, totalRows, totalCols,
			noData, rNeighbor, cNeighbor);		
		//cout << neighborSize << endl;
